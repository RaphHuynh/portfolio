...
export default function About() {
  return (
    <section className="min-h-screen bg-white dark:bg-[#181a1b] flex items-center" id="About">
      <div className="w-full px-28">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="md:col-span-2 flex flex-col justify-between">
            <div>
              <p className="text-2xl lg:text-3xl text-[#22304a] dark:text-stone-200 font-light mb-10 leading-snug">
            ...
            <div className="flex flex-wrap gap-16 mt-8 text-base text-[#22304a] dark:text-stone-400 font-light">
          ...
          <div className="flex flex-col justify-start">
            <p className="text-base lg:text-lg text-[#22304a] dark:text-stone-400 font-light leading-relaxed mb-4">
