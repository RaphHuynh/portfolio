                    ...
                    <div key={index} className="bg-white/80 dark:bg-transparent dark:border dark:border-amber-400 py-6 rounded-lg dark:rounded shadow-lg">
                        <div className="pb-4 md:pb-auto h-full">
                            <div className='flex w-full items-center justify-center px-10'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="75" height="75" class="bi bi-mortarboard" viewBox="0 0 16 16" className='fill-indigo-500 dark:fill-amber-400 my-2 dark:border-2 bg-indigo-200 dark:border-amber-400 rounded-full p-4'>
