...
export default function Formation() {
  return (
    <section className="min-h-screen w-full bg-[#19191c] text-[#d1d1d6] px-28 py-20 font-satoshi" id="Formation">
        ...
        {formations.map((f, i) => (
          <div key={i} className="grid grid-cols-12 gap-8 items-start">
            ...
            <div className="col-span-3 flex flex-col">
              <span className="text-3xl font-semibold text-[#e5e5e7] leading-tight mb-2">{f.diplome}</span>
            </div>
            {/* Colonne infos */}
