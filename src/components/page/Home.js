    ...
    return [
        <div id="Home" className="flex items-center w-full min-h-screen justify-center p-5">
            <div className="container max-w-4xl m-20 lg:m-auto">
                ...
                <a href={props.github.content} rel="noreferrer" className=" transition delay-150 box-border px-5 py-2 mt-4 border rounded border-cyan-300 text-center text-cyan-300 text-xl hover:bg-cyan-300/20" data-aos="fade" data-aos-duration="2000" data-aos-delay="2000" target="_blank">{props.github.id}</a>
            </div>
        </div>
    ]
}