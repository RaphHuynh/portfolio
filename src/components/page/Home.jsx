    ...
    return (
        <section className='flex flex-col sm:flex-row min-h-screen w-full  px-10 lg:px-32 gap-20 items-center justify-center' id='Home'>
            <article className='w-full lg:w-2/3'>
                <h1 className='text-xl md:text-4xl lg:text-6xl pb-4 lg:pb-10 text-indigo-500'>
                ...
                <div className='grid grid-cols-3 gap-2 md:gap-4 pb-4 lg:pb-6'>
                    <div className='px-4 py-2 md:py-6 rounded flex flex-col items-center text-center h-full border border-indigo-500 bg-indigo-200'>
                ...
                <div className='flex grid grid-cols-3 gap-4 text-center md:w-1/2'>
                    <a href={'https://www.linkedin.com/in/raphaëlle-huynh-46192919b/'} className='border border-amber-400 text-[#0f1628] px-2 py-1 bg-amber-400 hover:bg-indigo-300 hover:border-indigo-300 transition delay-75 text-sm md:text-lg rounded'>
                        LinkedIn
                    </a>
                    <a href={'https://github.com/RaphHuynh'} className='border border-amber-400 text-[#0f1628] px-2 py-1 bg-amber-400 hover:bg-indigo-300 hover:border-indigo-300 transition delay-75 text-sm md:text-lg rounded'>
                        Github
                    </a>
                    <a href={resume} className='border border-amber-400 text-[#0f1628] px-2 py-1 bg-amber-400 hover:bg-indigo-300 hover:border-indigo-300 transition delay-75 text-sm md:text-lg rounded'>
                        CV
                    </a>
                </div>
            </article>
