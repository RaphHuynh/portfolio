    ...
    return (
        <section className='flex flex-col sm:flex-row min-h-screen w-full pt-20 px-10 lg:px-32 gap-20 items-center' id='Home'>
            <article className='w-full lg:w-2/3'>
                <h1 className='text-2xl md:text-4xl lg:text-6xl pb-6 lg:pb-10 text-indigo-500 dark:text-amber-400'>
                    Bonjour 👋, je suis Raphaëlle Huynh
                </h1>
                <p className='flex text-sm lg:text-lg pb-4 lg:pb-6 gap-4 text-slate-600 dark:text-white'>
                    <span>
                        📍France, Reims
                    </span>
                    <span>
                ...
                <div className='grid grid-cols-3 gap-4 pb-4 lg:pb-6'>
                    <div className='px-4 py-6 rounded flex flex-col items-center text-center h-full border border-indigo-500 bg-indigo-200 dark:border-amber-400 dark:bg-transparent'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" class="bi bi-mortarboard" viewBox="0 0 16 16" className='fill-indigo-500 mb-2 dark:fill-amber-400'>
                            <path d="M8.211 2.047a.5.5 0 0 0-.422 0l-7.5 3.5a.5.5 0 0 0 .025.917l7.5 3a.5.5 0 0 0 .372 0L14 7.14V13a1 1 0 0 0-1 1v2h3v-2a1 1 0 0 0-1-1V6.739l.686-.275a.5.5 0 0 0 .025-.917zM8 8.46 1.758 5.965 8 3.052l6.242 2.913z" />
                            <path d="M4.176 9.032a.5.5 0 0 0-.656.327l-.5 1.7a.5.5 0 0 0 .294.605l4.5 1.8a.5.5 0 0 0 .372 0l4.5-1.8a.5.5 0 0 0 .294-.605l-.5-1.7a.5.5 0 0 0-.656-.327L8 10.466zm-.068 1.873.22-.748 3.496 1.311a.5.5 0 0 0 .352 0l3.496-1.311.22.748L8 12.46z" />
                        </svg>
                        <p className='text-xl font-black text-indigo-500 dark:text-white'>Etudiante en Master Informatique</p>
                    </div>
                    ...
                    <div className='px-4 py-6 rounded flex flex-col items-center text-center h-full border border-indigo-500 bg-indigo-200 dark:border-amber-400 dark:bg-transparent'>
                        ...
                        <p className='text-xl font-black text-indigo-500 dark:text-white'>Data Scientist</p>
                    </div>
                    ...
                    <div className='px-4 py-6 rounded flex flex-col items-center text-center h-full border border-indigo-500 bg-indigo-200 dark:border-amber-400 dark:bg-transparent'>
                        ...
                        <p className='text-xl font-black text-indigo-500 dark:text-white'>Freelance</p>
                    </div>
                </div>
                <p className='text-sm md:text-lg pb-4 lg:pb-6 text-slate-600 dark:text-white'>
            ...
            <aside className='hidden lg:block w-1/3'>
                <img src={"https://media.licdn.com/dms/image/D4E03AQE2qM_v5UQuAA/profile-displayphoto-shrink_800_800/0/1694529792449?e=2147483647&v=beta&t=n_5ZZft0O3O5HSOItCmqFyJRblehOuNuZTeAZBPvrpI"} className='rounded-full bg-indigo-500 dark:bg-amber-400 p-1'></img>
            </aside>
        </section>
    );
}
