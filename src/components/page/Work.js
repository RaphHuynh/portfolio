                        ...
                        {props.projet.map((proj) =>(
                            <div className="bg-black/10 w-72 sm:mx-5 my-5" data-aos="fade">
                                    ...
                                    <span className="flex mr-5 ml-auto items-center">
                                        {proj.github !== "" && 
                                            <a href={proj.github} target="_blank" rel="noreferrer">
                                                <svg viewBox="0 0 128 128" className="transition delay-75 w-7 fill-white/70 hover:fill-cyan-300/70">
                                ...
                                <div className="mx-5 mt-5">
                                    <h1 className="text-indigo-300/60 text-lg font-bold">{proj.id}</h1>
                                    <p className="text-justify text-white/50 my-3">{proj.content}</p>
                                </div>
                                <div className="flex mx-5 text-sm">
                                    <p className="my-5 text-cyan-300/60">{proj.langage}</p>
                                </div>
                            </div>
                        ))}
                    </div>
